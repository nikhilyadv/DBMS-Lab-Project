...
\begin{enumerate}
  ...
  \item When a product is sold, we need to add an entry to our track table for the same, "addTrack" (naturally it will have shipper\_id, tracking\_id field NULL as of now and this info will be used to determine whether the product has been shipped or not)
\end{enumerate}
\newpage
